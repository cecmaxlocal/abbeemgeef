...
Sub InitGfxLocal(G As Integer, Fx As Integer)
...
Sub FontCreateLocal(G As Integer, Fx As Integer, FC As String)
...
Sub FontFreeLocal(Fonts As String)
...
' Initialize graphics
InitGfxLocal(800, 600)

' Set font and color
Color RGB(255, 255, 255)
FontCreateLocal(12, 0, "Consolas")
